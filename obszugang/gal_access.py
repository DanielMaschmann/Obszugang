...
class PhangsSampleAccess:
    ...
    def __init__(self):
        ...
        self.phangs_sample_table_path = access_config.phangs_config_dict['phangs_sample_table_path']
        self.phangs_sample_table_ver = access_config.phangs_config_dict['phangs_sample_table_ver']
